...
McbpPrivilegeChains::McbpPrivilegeChains() {
    ...
    setup(ClientOpcode::PruneEncryptionKeys,
          require<Privilege::NodeSupervisor>);
    setup(ClientOpcode::RegisterAuthToken, require<Privilege::Impersonate>);
    ...
    setup(ClientOpcode::DcpCacheTransfer, require<Privilege::DcpConsumer>);
    setup(ClientOpcode::DcpCacheTransferEnd, require<Privilege::DcpConsumer>);
