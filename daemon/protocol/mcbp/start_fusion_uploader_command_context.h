...
/**
 * Command context for executing StartFusionUploader requests in a AUXIO
 * bg-thread and avoiding blocking IO in frontend threads.
 */
class StartFusionUploaderCommandContext
    : public BackgroundThreadCommandContext {
public:
    explicit StartFusionUploaderCommandContext(Cookie& cookie);
