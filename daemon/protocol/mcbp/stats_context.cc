...
static void stat_threads_emit_configured_and_actual(
    ...
    // derived sizes (e.g. "balanced", "disk_io_optimized" ) based on
    // the CPU count of the machine, for these we return the _actual_ number of
    // threads chosen.
 ...
 * statistics
 */
static std::unordered_map<StatGroupId, command_stat_handler> stat_handlers = {
        ...
        {StatGroupId::JsonValidate, {true, stat_json_validate_executor}},
        {StatGroupId::SnappyDecompress,
         {true, stat_snappy_decompress_executor}},
        {StatGroupId::SubdocExecute, {true, stat_subdoc_execute_executor}},
