...
/**
 * Command context for executing GetFusionNamespaces requests in a
 * AUXIO bg-thread and avoiding blocking IO in frontend threads.
 */
class GetFusionNamespacesCommandContext
    : public BackgroundThreadCommandContext {
public:
    explicit GetFusionNamespacesCommandContext(Cookie& cookie);
