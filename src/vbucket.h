...
public:
     ...
     *
     * @param v the dirty item
     * @param plh Hash table partition lock for the dirty item.
     *        This function now owns the lock and unlocks it inside the function
     * @param generateBySeqno request that the seqno is generated by this call
     *
     * @result seqno of the added item
     */
    uint64_t tapQueueDirty(StoredValue* v,
