...
const Priority Priority::BgFetcherGetMetaPriority(
                                          "bg_fetcher_meta_priority", 1);
const Priority Priority::WarmupPriority("warmup_priority", 0);
const Priority Priority::VKeyStatBgFetcherPriority(
                                        "vkey_stat_bg_fetcher_priority", 3);
...
const Priority Priority::VBucketDeletionPriority(
                                           "vbucket_deletion_priority", 1);
const Priority Priority::CompactorPriority("compactor_priority", 2);
const Priority Priority::VBucketPersistHighPriority(
                                           "vbucket_persist_high_priority", 2);
const Priority Priority::FlushAllPriority("flush_all_priority", 3);
const Priority Priority::FlusherPriority("flusher_priority", 5);
const Priority Priority::VBucketPersistLowPriority(
                                          "vbucket_persist_low_priority", 9);
const Priority Priority::StatSnapPriority("statsnap_priority", 9);
const Priority Priority::MutationLogCompactorPriority(
                                         "mutation_log_compactor_priority", 9);
...
const Priority Priority::TapConnNotificationPriority(
                                           "tapconn_notification_priority", 5);
const Priority Priority::CheckpointRemoverPriority(
                                           "checkpoint_remover_priority", 6);
const Priority Priority::TapConnectionReaperPriority(
                                           "tapconnection_reaper_priority", 6);
const Priority Priority::VBMemoryDeletionPriority(
                                           "vb_memory_deletion_priority", 6);
const Priority Priority::CheckpointStatsPriority(
                                           "checkpoint_stats_priority", 7);
