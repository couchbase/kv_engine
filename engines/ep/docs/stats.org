...
| ep_checkpoint_memory_overhead_allocator_bytes           | Memory of all checkpoints internal structures  |
| ep_checkpoint_memory_overhead_allocator_bytes_queue     | Memory of all checkpoint's queues              |
| ep_checkpoint_memory_overhead_allocator_bytes_index     | Memory of all checkpoint's index structures    |
| ep_checkpoint_memory_overhead_allocator_bytes_index_key | Memory of all keys in all checkpoint's indexes |
