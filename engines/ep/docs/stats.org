...
| ep_checkpoint_memory_overhead_allocator_bytes           | Mem of all checkpoints struct - from allocator |
| ep_checkpoint_memory_overhead_allocator_bytes_queue     | Mem of all checkpoints queues - from allocator |
| ep_checkpoint_memory_overhead_allocator_bytes_index     | Mem of all checkpoints index - from allocator  |
| ep_checkpoint_memory_overhead_allocator_bytes_index_key | Mem of keys in all indexes - from allocator    |
