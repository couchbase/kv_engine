...
| ep_checkpoint_memory              | Total memory used for checkpoints              |
| ep_checkpoint_memory_unreferenced | Memory used for unreferenced checkpoints       |
| ep_checkpoint_memory_overhead     | Memory overhead for checkpoints                |
...
| vb_active_checkpoint_memory              | Total memory taken by checkpoints          |
| vb_active_checkpoint_memory_unreferenced | Memory taken by unreferenced checkpoints   |
| vb_active_checkpoint_memory_overhead     | Memory overhead for checkpoints            |
...
| vb_replica_checkpoint_memory              | Total memory taken by checkpoints          |
| vb_replica_checkpoint_memory_unreferenced | Memory taken by unreferenced checkpoints   |
| vb_replica_checkpoint_memory_overhead     | Memory overhead for checkpoints            |
...
| vb_pending_checkpoint_memory              | Total memory taken by checkpoints          |
| vb_pending_checkpoint_memory_unreferenced | Memory taken by unreferenced checkpoints   |
| vb_pending_checkpoint_memory_overhead     | Memory overhead for checkpoints            |
