...
| ep_checkpoint_memory_overhead            | Memory of all checkpoints internal structures  |
| ep_checkpoint_memory_overhead_queue      | Memory of all checkpoint's queues              |
| ep_checkpoint_memory_overhead_index      | Memory of all checkpoint's index structures    |
| ep_checkpoint_memory_overhead_index_key  | Memory of all keys in all checkpoint's indexes |
