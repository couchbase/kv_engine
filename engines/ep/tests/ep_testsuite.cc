    ...
    std::map<std::string, std::vector<std::string> > statsKeys{
            ...
            {"", // Note: we convert empty to a null to get engine stats
             {"ep_allow_sanitize_value_in_deletion",
              ...
              "vb_active_checkpoint_memory_overhead_index_key",
              ...
              "vb_pending_checkpoint_memory_overhead_index_key",
              ...
              "vb_replica_checkpoint_memory_overhead_index_key",
