...
static enum test_result test_dcp_consumer_hotness_data(EngineIface* h) {
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, stream_opaque, vbid, 0, 1, 0, {} /*HCS*/),
            "Failed to send marker!");
...
static enum test_result test_dcp_reconnect(EngineIface* h,
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 0, 10, 2, {} /*HCS*/),
...
static enum test_result test_dcp_consumer_takeover(EngineIface* h) {
    ...
    dcp->snapshot_marker(cookie, stream_opaque, Vbid(0), 1, 5, 10, {} /*HCS*/);
    for (int i = 1; i <= 5; i++) {
        const std::string key{"key" + std::to_string(i)};
        const DocKey docKey(key, DocKeyEncodesCollectionId::No);
        checkeq(ENGINE_SUCCESS,
    ...
    dcp->snapshot_marker(cookie, stream_opaque, Vbid(0), 6, 10, 10, {} /*HCS*/);
    for (int i = 6; i <= 10; i++) {
        const std::string key{"key" + std::to_string(i)};
        const DocKey docKey(key, DocKeyEncodesCollectionId::No);
        checkeq(ENGINE_SUCCESS,
...
static enum test_result test_failover_scenario_two_with_dcp(EngineIface* h) {
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 0, 5, 0, {} /*HCS*/),
            "Failed to send marker!");
...
static enum test_result test_consumer_backoff_stat(EngineIface* h) {
    ...
    checkeq(dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 0, 20, 1, {} /*HCS*/),
            ENGINE_SUCCESS,
            "Failed to send snapshot marker");
...
static enum test_result test_dcp_consumer_mutate(EngineIface* h) {
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, opaque, Vbid(0), 10, 10, 1, {} /*HCS*/),
            "Failed to send snapshot marker");
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, opaque, Vbid(0), 10, 15, 300, {} /*HCS*/),
            "Failed to send marker!");
...
static enum test_result test_dcp_erroneous_mutations(EngineIface* h) {
    ...
    checkeq(dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 5, 10, 300, {} /*HCS*/),
            ENGINE_SUCCESS,
            "Failed to send snapshot marker!");
    for (int i = 5; i <= 10; i++) {
        const std::string key("key" + std::to_string(i));
...
static enum test_result test_dcp_erroneous_marker(EngineIface* h) {
    ...
    checkeq(dcp->snapshot_marker(
                    cookie1, stream_opaque, Vbid(0), 1, 10, 300, {} /*HCS*/),
            ENGINE_SUCCESS,
            "Failed to send snapshot marker!");
    for (int i = 1; i <= 10; i++) {
        const std::string key("key" + std::to_string(i));
    ...
    checkeq(dcp->snapshot_marker(
                    cookie2, stream_opaque, Vbid(0), 5, 10, 1, {} /*HCS*/),
            ENGINE_ERANGE,
    ...
    checkeq(dcp->snapshot_marker(
                    cookie2, stream_opaque, Vbid(0), 5, 15, 1, {} /*HCS*/),
            ENGINE_SUCCESS,
            "Failed to send snapshot marker!");
    for (int i = 5; i <= 15; i++) {
...
static enum test_result test_dcp_invalid_snapshot_marker(EngineIface* h) {
    ...
    checkeq(dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 1, 10, 300, {} /*HCS*/),
            ENGINE_SUCCESS,
            "Failed to send snapshot marker!");
    for (int i = 1; i <= 10; i++) {
        const std::string key("key" + std::to_string(i));
    ...
    checkeq(dcp->snapshot_marker(
                    cookie, stream_opaque, Vbid(0), 11, 8, 300, {} /*HCS*/),
            ENGINE_EINVAL,
            "Failed to send snapshot marker!");
...
static enum test_result test_get_all_vb_seqnos(EngineIface* h) {
    ...
    checkeq(ENGINE_SUCCESS,
            dcp->snapshot_marker(
                    cookie, stream_opaque, rep_vb_num, 0, 10, 1, {} /*HCS*/),
            "Failed to send snapshot marker!");
