...
/**
 * Ensure we don't crash due to a seg fault due to accessing freed memory of an
 * item when dereferencing a queued_item in Checkpoint::canDedup(). The
 * following steps will try and recreate the crash seen by MB-41283:
