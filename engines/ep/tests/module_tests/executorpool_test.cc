...
std::vector<ThreadCountsParams> threadCountValues = {
        ...
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 4, 4, 4, 8, 2},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 8, 8, 8, 16, 4},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 10, 10, 10, 20, 5},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 14, 14, 14, 28, 7},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 20, 20, 20, 40, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 24, 24, 24, 48, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 32, 32, 32, 64, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 48, 48, 48, 96, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 64, 64, 64, 128, 8},
