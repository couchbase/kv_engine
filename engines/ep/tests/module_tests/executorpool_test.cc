...
std::vector<ThreadCountsParams> threadCountValues = {
        ...
        {ThreadPoolConfig::ThreadCount::Default, 8, 8, 4, 16, 4},
        {ThreadPoolConfig::ThreadCount::Default, 10, 10, 4, 20, 5},
        {ThreadPoolConfig::ThreadCount::Default, 14, 14, 4, 28, 7},
        {ThreadPoolConfig::ThreadCount::Default, 20, 16, 4, 40, 8},
        {ThreadPoolConfig::ThreadCount::Default, 24, 16, 4, 48, 8},
        ...
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 4, 4, 8, 8, 2},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 8, 8, 16, 16, 4},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 10, 10, 20, 20, 5},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 14, 14, 28, 28, 7},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 20, 20, 40, 40, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 24, 24, 48, 48, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 32, 32, 64, 64, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 48, 48, 96, 96, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 64, 64, 128, 128, 8},
