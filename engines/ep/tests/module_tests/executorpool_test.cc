...
std::vector<ThreadCountsParams> threadCountValues = {
        ...
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 8, 16, 16, 16, 4},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 10, 20, 20, 20, 5},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 14, 28, 28, 28, 7},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 20, 40, 40, 40, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 24, 48, 48, 48, 8},
