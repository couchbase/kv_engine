...
std::vector<ThreadCountsParams> threadCountValues = {
        ...
        {ThreadPoolConfig::ThreadCount::Default, 8, 8, 4, 8, 4},
        {ThreadPoolConfig::ThreadCount::Default, 10, 10, 4, 10, 5},
        {ThreadPoolConfig::ThreadCount::Default, 14, 14, 4, 14, 7},
        {ThreadPoolConfig::ThreadCount::Default, 20, 16, 4, 20, 8},
        {ThreadPoolConfig::ThreadCount::Default, 24, 16, 4, 24, 8},
        {ThreadPoolConfig::ThreadCount::Default, 32, 16, 4, 32, 8},
        {ThreadPoolConfig::ThreadCount::Default, 48, 16, 4, 48, 8},
        {ThreadPoolConfig::ThreadCount::Default, 64, 16, 4, 64, 8},
        ...
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 8, 8, 8, 8, 4},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 10, 10, 10, 10, 5},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 14, 14, 14, 14, 7},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 20, 20, 20, 20, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 24, 24, 24, 24, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 32, 32, 32, 32, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 48, 48, 48, 48, 8},
        {ThreadPoolConfig::ThreadCount::DiskIOOptimized, 64, 64, 64, 64, 8},
