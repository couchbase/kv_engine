...
TEST_P(ConnectionTest, consumer_get_error_map) {
    ...
    for (auto prodIsV5orHigher : {true, false}) {
        ...
        // Note: need to create a raw pointer as the resource will be released
        //     in EventuallyPersistentEngineTest::TearDown().
        ...
        ASSERT_FALSE(consumer->getProducerIsVersion5orHigher());
