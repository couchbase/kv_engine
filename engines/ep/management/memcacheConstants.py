...
# Fusion
CMD_GET_FUSION_STORAGE_SNAPSHOT = 0x70
CMD_RELEASE_FUSION_STORAGE_SNAPSHOT = 0x71
CMD_MOUNT_FUSION_VBUCKET = 0x72
CMD_UNMOUNT_FUSION_VBUCKET = 0x73
CMD_SYNC_FUSION_LOGSTORE = 0x74,
CMD_START_FUSION_UPLOADER = 0X75
CMD_STOP_FUSION_UPLOADER = 0X76
CMD_DELETE_FUSION_NAMESPACE = 0x77
CMD_GET_FUSION_NAMESPACE = 0x78
