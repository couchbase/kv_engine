...
* Quick Non IO `TaskType::QuickNonIO`
 * Short duration tasks that do not perform 'disk' I/O.
   Intended to not be blocked by longer duration tasks.
