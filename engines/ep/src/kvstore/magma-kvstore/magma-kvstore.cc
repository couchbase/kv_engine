...
MagmaKVStore::MagmaKVStore(MagmaKVStoreConfig& configuration,
    ...
    configuration.magmaCfg.EnableIndexBlockAutoTuning =
            configuration.isMagmaEnableIndexBlockAutotuning();
    ...
    if (engine) {
        // Add bucket name to prefix for all magma logs
        logger->setPrefix(nlohmann::ordered_json{{"bucket", engine->getName()}},
                          "");
    }
...
void MagmaKVStore::initialize(EncryptionKeyProvider* encryptionKeyProvider,
    ...
    magma->SetFusionMaxUploadInterval(
            configuration.getFusionMaxUploadInterval());
...
GetStatsMap MagmaKVStore::getStats(
    ...
    fill("fusion_NumSyncAttempts", magmaStats->FusionFSStats.NumSyncAttempts);
    fill("fusion_NumBytesSynced", magmaStats->FusionFSStats.NumBytesSynced);
    fill("fusion_NumBytesIncoming", magmaStats->FusionFSStats.NumBytesIncoming);
    ...
    fill("fusion_LogStoreDataSize", magmaStats->FusionFSStats.LogStoreDataSize);
    fill("fusion_LogStoreGarbageSize",
         magmaStats->FusionFSStats.LogStoreGarbageSize);
    fill("fusion_LogStoreSummarySectionSize",
         magmaStats->FusionFSStats.LogStoreSummarySectionSize);
    ...
    fill("fusion_NumLogsMerged", magmaStats->FusionFSStats.NumLogsMerged);
    fill("fusion_NumLogMergerBytesRead",
         magmaStats->FusionFSStats.NumLogMergerBytesRead);
    ...
    fill("fusion_PendingCheckpointBytes",
         magmaStats->FusionPendingCheckpointBytes);
    ...
    fill("fusion_NumCheckpointFailures",
         magmaStats->FusionFSStats.NumCheckpointFailures);
    ...
    /* Continuous Backup Stats */
    fill("magma_contbk_NBackups", magmaStats->BackupStats.NBackups);
    fill("magma_contbk_NFailedBackups", magmaStats->BackupStats.NFailedBackups);
    fill("magma_contbk_NBackupHardlinks",
         magmaStats->BackupStats.NBackupHardlinks);
    fill("magma_contbk_NWriteIOs", magmaStats->BackupStats.NWriteIOs);
    fill("magma_contbk_NBytesWritten", magmaStats->BackupStats.NBytesWritten);
    fill("magma_contbk_NTableBytesBackedUp",
         magmaStats->BackupStats.NTableBytesBackedup);
    return stats;
}
...
void MagmaKVStore::setMagmaFusionMaxUploadInterval(std::chrono::seconds value) {
    magma->SetFusionMaxUploadInterval(value);
}

std::chrono::seconds MagmaKVStore::getMagmaFusionMaxUploadInterval() const {
