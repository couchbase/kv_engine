...
public:
    ...
    /**
     * Retrieve a EPVbucket reference from the underlying VBucketPtr.
     * The caller is responsible for
     *  1) checking that the VBucketPtr points to a VBucket
     *  2) the VBucket is a EPVbucket
     *
     * In the case where 2) is violated std::bad_cast is thrown.
     *
     * @return a reference generated by dynamic_cast from VBucketPtr
     */
