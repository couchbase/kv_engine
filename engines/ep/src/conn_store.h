...
public:
    ...
    struct CookieToConnMapHandle {
         ...
         */
        void addConnByCookie(CookieIface* cookie,
         ...
         * @param cookie the cookie mapping to the ConnHandler
         */
        void removeConnByCookie(CookieIface* cookie);
     ...
     * @return True if the ConnHandler exists
     */
    bool doesVbConnExist(Vbid vbid, CookieIface* cookie);
     ...
     * @param cookie the cookie mapping to the ConnHandler
     */
    void removeVBConnByVbid(Vbid vbid, CookieIface* cookie);
