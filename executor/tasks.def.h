...
TASK(MonitorTask, TaskType::NonIO, 0)
...
TASK(GetRandomKeyVisitor, TaskType::NonIO, 8)
...
TASK(Core_ExpiredTopKeysRemover, TaskType::NonIO, 10)
...
TASK(DurabilityCompletionTask, TaskType::QuickNonIO, 1)
TASK(DcpConsumerTask, TaskType::QuickNonIO, 2)
TASK(ActiveStreamCheckpointProcessorTask, TaskType::QuickNonIO, 3)

// Slow IO tasks
TASK(DownloadSnapshotTask, TaskType::SlowIO, 0)
