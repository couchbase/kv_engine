...
ValidatorTest::ValidatorTest()
    : ev(event_base_new()), connection(-1, ev),
      request(*reinterpret_cast<protocol_binary_request_no_extras *>(blob)) {
  settings.extensions.logger = get_stderr_logger();
}

ValidatorTest::~ValidatorTest() { event_base_free(ev); }
...
ValidatorTest::validate(protocol_binary_command opcode, void *packet) {
  ...
  const size_t size = 24 + connection.binary_header.request.bodylen;
  ...
  connection.read->consume(
      [](cb::const_byte_buffer buffer) -> ssize_t { return buffer.size(); });
  return rv;
}
...
INSTANTIATE_TEST_CASE_P(GetOpcodes, GetValidatorTest,
                        ::testing::Values(GetOpcodes::Get, GetOpcodes::GetQ,
                                          GetOpcodes::GetK, GetOpcodes::GetKQ,
                                          GetOpcodes::GetMeta,
                                          GetOpcodes::GetQMeta),
...
protected:
  ...
  protocol_binary_request_dcp_open &request =
      *reinterpret_cast<protocol_binary_request_dcp_open *>(blob);
};
...
public:
  DcpMutationValidatorTest()
      : request(GetParam(), 0 /*opaque*/, 0 /*vbucket*/, 0 /*cas*/,
                1 /*keylen*/, 0 /*valueLen*/, PROTOCOL_BINARY_RAW_BYTES,
                0 /*bySeqno*/, 0 /*revSeqno*/, 0 /*flags*/, 0 /*expiration*/,
                0 /*lockTime*/, 0 /*nmeta*/, 0 /*nru*/, 0 /*collectionLen*/) {}
...
INSTANTIATE_TEST_CASE_P(CollectionsOnOff, DcpMutationValidatorTest,
...
public:
  DcpDeletionValidatorTest()
      : ValidatorTest(),
        request(GetParam(), 0 /*opaque*/, 0 /*vbucket*/, 0 /*cas*/,
                2 /*keylen*/, 0 /*valueLen*/, PROTOCOL_BINARY_RAW_BYTES,
                0 /*bySeqno*/, 0 /*revSeqno*/, 0 /*nmeta*/,
                0 /*collectionLen*/) {
...
INSTANTIATE_TEST_CASE_P(CollectionsOnOff, DcpDeletionValidatorTest,
                        ::testing::Bool(), ::testing::PrintToStringParamName());
...
TEST_P(DcpDeletionValidatorTest, ValidDatatype) {
  ...
  const std::array<uint8_t, 2> datatypes = {
      {uint8_t(Datatype::Raw), uint8_t(Datatype::Xattr)}};
...
TEST_P(DcpDeletionValidatorTest, InvalidDatatype) {
  ...
  const std::array<uint8_t, 6> datatypes = {
      {uint8_t(Datatype::JSON), uint8_t(Datatype::Snappy),
...
INSTANTIATE_TEST_CASE_P(CollectionsOnOff, DcpExpirationValidatorTest,
                        ::testing::Bool(), ::testing::PrintToStringParamName());
...
std::string to_string(const RefreshOpcodes &opcode) {
  ...
  throw std::invalid_argument(
      "to_string(const RefreshOpcodes&): unknown opcode");
#endif
}
...
INSTANTIATE_TEST_CASE_P(RefreshOpcodes, RefreshValidatorTest,
