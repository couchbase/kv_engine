...
INSTANTIATE_TEST_CASE_P(
    Opcodes, MutationWithMetaTest,
    ::testing::Values(Opcodes::SetWithMeta, Opcodes::SetQWithMeta,
                      Opcodes::AddWithMeta, Opcodes::AddQWithMeta,
                      Opcodes::DelWithMeta, Opcodes::DelQWithMeta),
