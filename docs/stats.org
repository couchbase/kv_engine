...
These are available as "raw workload" stats:
...
| shard#_pendingTasks      | number of tasks blocked by shard serialization   |
| shard#_locked            | true or false based on shard serialization       |
