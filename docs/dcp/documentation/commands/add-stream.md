...
* 0x100 (CacheTransfer) - Requests that the stream should also transfer the cache of the active vbucket. Full details are in [Stream Request documentation.](stream-request.md)
