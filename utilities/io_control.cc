...
Manager::Manager()
    : entries({{Id::JemallocProfActive,
               ...
               {Id::ServerlessMaxConnectionsPerBucket,
                ...
                Mode::WRONLY},
               {Id::ServerlessReadComputeUnitSize,
                "serverless.read_compute_unit_size",
                "Set the size for the Read Compute Unit (in bytes)",
                Mode::WRONLY},
               {Id::ServerlessWriteComputeUnitSize,
                "serverless.write_compute_unit_size",
                "Set the size for the Write Compute Unit (in bytes)",
                Mode::WRONLY},
               {Id::Sla,
                "sla",
