...
struct DcpMessageProducersIface {
    ...
    [[nodiscard]] virtual cb::engine_errc get_failover_log(uint32_t opaque,
                                                           Vbid vbucket) = 0;
    ...
    [[nodiscard]] virtual cb::engine_errc add_stream_rsp(
            uint32_t opaque,
            uint32_t stream_opaque,
            cb::mcbp::Status status) = 0;

    [[nodiscard]] virtual cb::engine_errc marker_rsp(
            uint32_t opaque, cb::mcbp::Status status) = 0;

    [[nodiscard]] virtual cb::engine_errc set_vbucket_state_rsp(
            uint32_t opaque, cb::mcbp::Status status) = 0;
     ...
     *         ENGINE_* for errors
     */
    [[nodiscard]] virtual cb::engine_errc stream_end(
            uint32_t opaque,
            Vbid vbucket,
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc marker(
            uint32_t opaque,
            Vbid vbucket,
            uint64_t start_seqno,
            uint64_t end_seqno,
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc mutation(
            uint32_t opaque,
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc set_vbucket_state(
            uint32_t opaque, Vbid vbucket, vbucket_state_t state) = 0;
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc noop(uint32_t opaque) = 0;
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc buffer_acknowledgement(
            uint32_t opaque, uint32_t buffer_bytes) = 0;
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc control(uint32_t opaque,
                                                  std::string_view key,
     ...
     * @return cb::engine_errc::success upon success
     */
    [[nodiscard]] virtual cb::engine_errc system_event(
            uint32_t opaque,
            Vbid vbucket,
     ...
     *
     * @param document_state Are we storing a deletion operation?
     * @param level the durability specification for this item
     */
     ...
     */
    [[nodiscard]] virtual cb::engine_errc seqno_acknowledged(
            uint32_t opaque, Vbid vbucket, uint64_t prepared_seqno) = 0;
     ...
     */
    [[nodiscard]] virtual cb::engine_errc oso_snapshot(
            uint32_t opaque,
            Vbid vbucket,
            uint32_t flags,
            cb::mcbp::DcpStreamId sid) = 0;

    [[nodiscard]] virtual cb::engine_errc seqno_advanced(
            uint32_t opaque,
            Vbid vbucket,
            uint64_t seqno,
            cb::mcbp::DcpStreamId sid) = 0;
...
struct DcpIface {
     ...
     */
    [[nodiscard]] virtual cb::engine_errc step(
            CookieIface& cookie,
            bool throttled,
     ...
     * @return
     */
    [[nodiscard]] virtual cb::engine_errc close_stream(
            CookieIface& cookie,
            uint32_t opaque,
            Vbid vbucket,
            cb::mcbp::DcpStreamId sid) = 0;
     ...
     */
    [[nodiscard]] virtual cb::engine_errc get_failover_log(
            CookieIface& cookie,
            uint32_t opaque,
            Vbid vbucket,
     ...
     */
    [[nodiscard]] virtual cb::engine_errc snapshot_marker(
            CookieIface& cookie,
            uint32_t opaque,
            Vbid vbucket,
            uint64_t start_seqno,
     ...
     */
    [[nodiscard]] virtual cb::engine_errc noop(CookieIface& cookie,
                                               uint32_t opaque) = 0;
     ...
     */
    [[nodiscard]] virtual cb::engine_errc buffer_acknowledgement(
            CookieIface& cookie, uint32_t opaque, uint32_t buffer_bytes) = 0;
     ...
     * @return Standard engine error code.
     */
    [[nodiscard]] virtual cb::engine_errc control(CookieIface& cookie,
                                                  uint32_t opaque,
                                                  std::string_view key,
                                                  std::string_view value) = 0;
     ...
     * @return Standard engine error code.
     */
    [[nodiscard]] virtual cb::engine_errc response_handler(
