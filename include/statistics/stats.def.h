...
STAT(ep_bg_fetched_compaction, , count, , )
...
STAT(ep_warmup_state, , none, , )
PSTAT(ep_warmup_status, none, )
STAT(ep_warmup_key_count, , count, , )
STAT(ep_warmup_value_count, , count, , )
STAT(ep_warmup_min_item_threshold, , count, , )
STAT(ep_warmup_keys_time, , microseconds, , )
STAT(ep_warmup_estimated_key_count, , none, , )
STAT(ep_warmup_estimate_time, , microseconds, , )
STAT(ep_warmup_access_log, , none, , )
STAT(ep_warmup_estimated_value_count, , none, , )
STAT(ep_warmup_access_log_keys_loaded, , count, , )
...
STAT(ep_magma_seqindex_compactions, , count, , )
STAT(ep_magma_flushes, , count, , )
STAT(ep_magma_ttl_compactions, , count, , )
STAT(ep_magma_filecount_compactions, , count, , )
STAT(ep_magma_keyindex_filecount_compactions, , count, , )
STAT(ep_magma_seqindex_filecount_compactions, , count, , )
STAT(ep_magma_writer_compactions, , count, , )
STAT(ep_magma_keyindex_writer_compactions, , count, , )
STAT(ep_magma_seqindex_writer_compactions, , count, , )
// Read amp.
...
STAT(ep_magma_checkpoint_disk_usage, , bytes, , )
STAT(ep_magma_active_disk_usage, , bytes, , )
// Memory usage.
...
STAT(vb_checkpoint_memory_overhead_allocator,
...
STAT(vb_mem_freed_by_checkpoint_removal,
     FMT("vb_{state}_mem_freed_by_checkpoint_removal"),
     bytes,
     , )
...
STAT(vb_ht_max_size, FMT("vb_{state}_ht_max_size"), none, vb_ht_max_size, )
STAT(vb_ht_avg_size, FMT("vb_{state}_ht_avg_size"), none, vb_ht_avg_size, )
...
STAT(ep_checkpoint_memory_quota, , bytes, , )
STAT(ep_checkpoint_memory_recovery_upper_mark_bytes, , none, , )
STAT(ep_checkpoint_memory_recovery_lower_mark_bytes, , none, , )
